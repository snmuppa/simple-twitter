...
* [X] Butter Knife to reduce boiler plate code for binding views and callbacks to fields and methods.
* [X] Used Gson to Deserialize the Twitter Api responses to Pojos.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://raw.githubusercontent.com/snmuppa/simple-twitter/master/demos/TwisterTweets-Demo-2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
